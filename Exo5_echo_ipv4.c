...
/*Le serveur utilise des sockets IPv4. L'option -6 dans netcat (nc) indique à netcat d'utiliser IPv6 pour la connexion. Comme le serveur n'est pas configuré pour gérer les connexions IPv6, la tentative de connexion échouera.*/
